...
const Addproduct = () => {
  ...
  return (
    <div className="container"> {/* Added Bootstrap container class */}
      <h3 className="mb-4 title text-center">Add Product</h3> {/* Added Bootstrap text-center class */}
      <div>
        <form
        ...
        >
          ...
          />
          <div className="error text-danger"> {/* Added Bootstrap text-danger class for error */}
            ...
            <Dropzone onDrop={(acceptedFiles) => setImages(acceptedFiles)}>
              {({ getRootProps, getInputProps }) => (
                <section>
                  <div {...getRootProps()}>
                    <input {...getInputProps()} />
                    <div className="text-secondary">Drag & drop some files here, or click to select files</div>
                  </div>
                </section>
              )}
            </Dropzone>
